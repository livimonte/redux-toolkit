...
import { Button, ButtonPagination, Loading, LoadingIcon, Star, } from '../utils/ui'
import { sleep, useDebounceText } from '../utils/helpers'
import { useCharacterStore, useFilterStore } from '../app/zustand-stores'
...
const ReactQueryZustand = () => {
  ...
  const { searchFilter, setSearchFilter } = useFilterStore() // Zustand Client State
  ...
  const handleShowFavorites = async () => {
    ...
    setShowLiked((oldState) => !oldState)
  }
                  ...
                  <div
                    ...
                    <div className="absolute top-2 right-2 transition-all duration-200 ease-in-out hover:opacity-80">
                      <button
                        ...
                        className="text-center text-sm rounded py-0 px-0 bg-transparent text-gray-700 hover:text-gray-500 transition-colors font-bold">
